...
🔹𝗧𝗵𝗲 𝗧𝘄𝗼 𝗠𝗼𝗱𝗲𝘀 𝗬𝗼𝘂 𝗔𝗰𝘁𝘂𝗮𝗹𝗹𝘆 𝗡𝗲𝗲𝗱 —
𝟭) 𝗡𝗼𝗿𝗺𝗮𝗹 𝗠𝗼𝗱𝗲 (𝗱𝗲𝗳𝗮𝘂𝗹𝘁)
You’re not typing text. You’re giving commands.
Useful stuff here:
 • dd → delete line
 • yy → copy line
 • p → paste
 ...
 • /word → search word
𝟮) 𝗜𝗻𝘀𝗲𝗿𝘁 𝗠𝗼𝗱𝗲
Where you actually type like a normal human.
...
• Save and Exit
    :wq → save + quit
    :x  → save + quit (only saves if changes exist) 
    ZZ  → save + quit (Normal mode shortcut)
• Quit Without Saving
    :q! → ditch everything and quit
...
When you’re learning Linux or cloud engineering, you’ll eventually hit things like:
 ...
 • fixing something inside a Docker container
 Half the time, nano isn’t installed, but vi is always there.
 That’s why I had no choice — I needed vim to stop getting stuck.
